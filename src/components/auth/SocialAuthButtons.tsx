  ...
  return (
    <div className="space-y-3 w-full">
      ...
      <button
        ...
        disabled={isLoading}
        className="w-full h-11 flex items-center justify-center gap-3 px-4 rounded-2xl border border-slate-200/90 dark:border-slate-800 bg-white/90 dark:bg-slate-900/90 text-slate-800 dark:text-slate-100 font-bold text-xs sm:text-sm hover:bg-slate-50 dark:hover:bg-slate-800 hover:border-slate-300 dark:hover:border-slate-700 transition-all duration-200 shadow-sm active:scale-[0.99] disabled:opacity-60 cursor-pointer"
      >
      ...
      <div className="relative flex items-center justify-center my-6">
        ...
        <span className="bg-white/80 dark:bg-slate-900/80 backdrop-blur-md px-3 text-[11px] uppercase font-extrabold text-slate-400 shrink-0">
