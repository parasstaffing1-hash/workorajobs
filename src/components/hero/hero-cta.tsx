...
export function HeroCTA() {
  return (
    <div className="flex flex-wrap items-center justify-center gap-3.5 mt-6 mb-12 relative z-20">
      {/* Primary CTA */}
      <Link
      ...
      <Link
        href="/services"
        className="w-full sm:w-auto h-12 px-5 rounded-xl glass-hero-card text-slate-700 dark:text-slate-200 hover:text-blue-500 font-medium text-xs sm:text-sm flex items-center justify-center gap-2 transition-all duration-200"
      >
      ...
      {/* Trust pill note */}
      <div className="hidden xl:flex items-center gap-1.5 text-xs text-slate-500 dark:text-slate-400 ml-2">
