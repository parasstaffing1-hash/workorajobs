        ...
        >
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 top-full hidden group-hover:block z-50 min-w-[200px] rounded-lg border border-border/70 bg-card/95 p-1.5 shadow-premium backdrop-blur-xl">
              <Link href="/ai-tools" className="block rounded-md px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-secondary/80 hover:text-foreground">AI Workbench</Link>
              <Link href="/career-copilot" className="block rounded-md px-3 py-2 text-sm font-medium text-muted-foreground hover:bg-secondary/80 hover:text-foreground">Career Copilot</Link>
