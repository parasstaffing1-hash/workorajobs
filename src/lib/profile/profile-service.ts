  ...
  static async getProfileByUserId(userId: string): Promise<CompleteJobSeekerProfile> {
    ...
    if (user) {
      ...
      const preferences: CareerPreferences = {
        ...
        salaryExpectation: p?.salaryExpectation ? Number(p.salaryExpectation) : undefined,
        workMode: (p?.workMode as any) || undefined,
        jobType: (p?.jobType as any) || undefined,
        noticePeriod: (p?.noticePeriod as any) || undefined,
